...
def dqn_loss(batch: Tuple[Tensor, Tensor], net: nn.Module, target_net: nn.Module, gamma: float = 0.99,loss_type =nn.MSELoss ) -> Tensor:
    ...
    return loss_type(state_action_values, expected_state_action_values)
